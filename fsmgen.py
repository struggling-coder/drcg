...
for digit in range(0, 10): print "pcp_standby"+str(digit)+", "
print "pcp_trn100);"
...
#	print "\t\tmode"+str(digit)+" <= '0';\n\t\tctrl <= pcp_tsth"+str(digit)+"0 after 1 ns;\n"
	...
	print "\twhen pcp_standby"+str(digit)+" => "
	print "\t\tmode"+str(digit)+" <= '0';"
	print "\t\tctrl <= pcp_trn"+str(digit)+"0 after 1 ns;\n"
